...
#include "RateStateFrictionLaw3D.h"
...
registerMooseObject("farmsquakeworxApp", RateStateFrictionLaw3D);

InputParameters
RateStateFrictionLaw3D::validParams()
{ 
...
RateStateFrictionLaw3D::RateStateFrictionLaw3D(const InputParameters & parameters)
...
void
RateStateFrictionLaw3D::computeInterfaceTractionAndDerivatives()
{   
    //Define Parameters
    Real len = _len;
    Real f_o = _f_o;
