...
#include "RateStateFrictionLaw2D.h"
...
registerMooseObject("farmsquakeworxApp", RateStateFrictionLaw2D);

InputParameters
RateStateFrictionLaw2D::validParams()
{ 
...
RateStateFrictionLaw2D::RateStateFrictionLaw2D(const InputParameters & parameters)
...
void
RateStateFrictionLaw2D::computeInterfaceTractionAndDerivatives()
{   
    //Define Parameters
    Real len = _len;
    Real f_o = _f_o;
