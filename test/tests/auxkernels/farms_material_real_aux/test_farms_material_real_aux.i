# Integration test for FarmsMaterialRealAux
# Extracts local fault quantities from CZM material properties
# Uses the same CZM setup as slip_weakening_czm_2d test
...
[AuxVariables]
  ...
  [ini_normal_stress]
    ...
    family = MONOMIAL
  []
  # FarmsMaterialRealAux output variables
  [local_shear_jump]
    order = FIRST
    family = MONOMIAL
  []
...
[AuxKernels]
  ...
  [NormalStress]
    ...
    function = func_normal_stress
    execute_on = 'LINEAR TIMESTEP_BEGIN'
  []
  # FarmsMaterialRealAux kernels
  [get_local_shear_jump]
