# Integration test for ComputeDamageBreakageStress3DSlipWeakening
# 3D CDBM material with slip weakening on fault interface
# Uses explicit time integration with CentralDifference
...
[Materials]
  ...
  [static_initial_strain_tensor]
    ...
    tensor_functions = 'func_initial_strain_xx func_zero              func_zero
                        func_zero              func_initial_strain_yy func_zero
                        func_zero              func_zero              func_initial_strain_zz'
  []
