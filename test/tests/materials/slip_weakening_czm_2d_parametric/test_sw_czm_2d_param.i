# Integration test for SlipWeakeningFrictionczm2dParametricStudy
# 2D CZM with parametric study slip weakening friction
# Tests default mode (no fractal, no nucleation patch)
